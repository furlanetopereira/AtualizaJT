				 ...
				 <div class="widget-body">
					 <div class="portlet-body">
						<form name="form_incluir_atualizacao" class="form-vertical" method="post" action="">
							<input type="hidden" name="id" id="id" value="<?=$consulta[0]->get('id');?>" />
							<input type="hidden" name="pesq_id" id="pesq_id" value="<?=$consulta[0]->get('id');?>" />
								...
								<div class="span12">
									<div class="control-group">
										...
										<div class="controls controls-row">
											<input type="text" class="input-block-level span4" name="num_processo" id="num_processo" value="<?=$consulta[0]->get('num_processo');?>">
										</div>
									</div>
								</div>
							</div>
							<div class="row-fluid">
								<div class="span5">
									<div class="control-group">
										...
										<div class="controls controls-row">
											<input type="text" class="input-block-level span6" name="data_original" id="data_original" value="<?=$consulta[0]->get('data_original');?>">
										</div>
									</div>
								</div>
								<div class="span7">
									<div class="control-group">
										...
										<div class="controls controls-row">
											<input type="text" class="input-block-level span3" name="valor_original" id="valor_original" value="<?=$Aplicacao->Bd2real($consulta[0]->get('valor_original'));?>">
										</div>
									</div>
								</div>
							</div>
							<div class="row-fluid">
								<div class="span5">
									<div class="control-group">
										...
										<div class="controls controls-row">
											<input type="text" class="input-block-level span6" name="data_atualizar" id="data_atualizar" value="<?=$consulta[0]->get('data_atualizar');?>">
										</div>
									</div>
								</div>
								<div class="span7">
									<div class="control-group">
										...
										<div class="controls controls-row">
											<input type="text" class="input-block-level span4" name="data_ajuizamento" id="data_ajuizamento" value="<?=$consulta[0]->get('data_ajuizamento');?>">
										</div>
									</div>
								</div>
							</div>
							<div class="row-fluid">
								<div class="span5">
									<div class="control-group">
										...
										<div class="controls controls-row">
											<input type="text" class="input-block-level span4" name="valor_ir" id="valor_ir" value="<?=$Aplicacao->Bd2real($consulta[0]->get('valor_ir'));?>">
										</div>
									</div>
								</div>
								<div class="span7">
									<div class="control-group">
										...
										<div class="controls controls-row">
											<input type="text" class="input-block-level span2" name="percentual_ir" id="percentual_ir" value="<?=$Aplicacao->Bd2real($consulta[0]->get('percentual_ir'));?>">
										</div>
									</div>
								</div>
							</div>
							<div class="row-fluid">
								<div class="span5">
									<div class="control-group">
										...
										<div class="controls controls-row">
											<input type="text" class="input-block-level span3" name="num_meses" id="num_meses" value="<?=$consulta[0]->get('num_meses');?>">
										</div>
									</div>
								</div>
								<div class="span7">
									<div class="control-group">
										...
										<div class="controls controls-row">
											<input type="text" class="input-block-level span2" name="num_dependentes" id="num_dependentes" value="<?=$consulta[0]->get('num_dependentes');?>">
										</div>
									</div>
								</div>
							</div>
