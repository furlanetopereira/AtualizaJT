        ...
        <div class="subpage">
			...
			<table cellpadding="5" cellspacing="0" border="0">
				...
				<tr>
					...
					<tr>
						<td class="borda-l"></td>
						<td class="borda-b explicativo"><?php echo "Índice: ".$Aplicacao->Bd2Indice($indice)." &nbsp; &nbsp; &nbsp; &nbsp; Cálculo:  R$ ".$Aplicacao->Bd2real($valor_ir)." x ".$Aplicacao->Bd2Indice($indice); ?></td>
						<td class="borda-b"></td>
						<td class="borda-r"></td>
					</tr>
				...
				<tr>
					<td class="borda-l"></td>
					<td class="borda-b explicativo"><?php echo "Cálculo:  R$ ".$Aplicacao->Bd2real($ir_atualizado)." x ".$Aplicacao->Bd2percentual($valor_aliquota)."%"; ?></td>
					<td class="borda-b"></td>
					<td class="borda-r"></td>
				</tr>
				<tr class="total">
					<td class="borda-l"></td>
					<td class="borda-bb">Valor do Imposto de Renda considerando a dedução de R$ <?php echo $Aplicacao->Bd2real($valor_parcela); ?></td>
					<td></td>
					<td class="borda-b explicativo" rowspan="2">R$</td>
				...
				<tr>
					<td class="borda-b borda-l"></td>
					<td class="borda-b explicativo"><?php echo "Cálculo:  R$ ".$Aplicacao->Bd2real($ir_atualizado_com_aliquota)." - R$ ".$Aplicacao->Bd2real($valor_parcela);?></td>
					<td class="borda-b"></td>
					<td class="borda-b borda-r"></td>
				</tr>
			...
			<table cellpadding="5" cellspacing="0" border="0">
				...
				<tr>
					...
					<td class="borda-bb borda-t">
						<?php echo "Valor da Contribuição Previdenciária, cota parte Reclamante:";?>
					</td>
					<td class="borda-t"></td>
					<td class="borda-bb borda-t explicativo">R$</td>
					<td class="borda-bb borda-t" align="center"><?php echo $Aplicacao->Bd2real($consulta->get('inss_reclamante')); ?></td>
				...
				<tr	>
					<td class="borda-l borda-t"></td>
					<td class="borda-b borda-t">Base de Cálculo da Contribuição Previdenciária Empregador, em <?php echo $Aplicacao->Data2String($consulta->get('data_original')); ?>:</td>
				...
				<tr>
					<td class="borda-l"></td>
					<td class="borda-b explicativo"><?php echo "Cálculo:  R$ ".$Aplicacao->Bd2real($consulta->get('valor_tributavel'))." x ".$Aplicacao->Bd2percentual($consulta->get('taxa_inss_empregador'))."%"; ?></td>
					<td class="borda-b"></td>
					<td class="borda-r"></td>
				</tr>
				<tr>
				...
				<tr>
					<td class="borda-l"></td>
					<td class="borda-b explicativo"><?php echo "Cálculo:  R$ ".$Aplicacao->Bd2real($valor_taxa_inss_empregador)." x ".$Aplicacao->Bd2Indice($indice); ?></td>
					<td class="borda-b"></td>
					<td class="borda-r"></td>
				</tr>
				<?php } ?>
				...
				<tr>
					...
					<td></td>
					<td class="borda-b explicativo" rowspan="2">R$</td>
					<td class="borda-b" align="center" rowspan="2"><?php echo $Aplicacao->Bd2real($valor_taxa_inss_sat); ?></td>
					<td class="borda-r"></td>
				</tr>
				<tr>
					<td class="borda-l"></td>
					<td class="borda-b explicativo"><?php echo "Cálculo:  R$ ".$Aplicacao->Bd2real($consulta->get('valor_tributavel'))." x ".$Aplicacao->Bd2percentual($consulta->get('taxa_inss_sat'))."%"; ?></td>
					<td class="borda-b"></td>
					<td class="borda-r"></td>
				</tr>
				<tr>
				...
				<tr>
					<td class="borda-l"></td>
					<td class="borda-b explicativo"><?php echo "Cálculo:  R$ ".$Aplicacao->Bd2real($valor_taxa_inss_sat)." x ".$Aplicacao->Bd2Indice($indice); ?></td>
					<td class="borda-b"></td>
					<td class="borda-r"></td>
				</tr>
				<?php } ?>
				...
				<tr>
					<td class="borda-l"></td>
					<td class="borda-b explicativo"><?php echo "Cálculo:  R$ ".$Aplicacao->Bd2real($consulta->get('valor_tributavel'))." x ".$Aplicacao->Bd2percentual($consulta->get('taxa_inss_terceiros'))."%"; ?></td>
					<td class="borda-b"></td>
					<td class="borda-r"></td>
				</tr>
				<tr>
				...
				<tr>
					<td class="borda-l"></td>
					<td class="borda-b explicativo"><?php echo "Cálculo:  R$ ".$Aplicacao->Bd2real($valor_taxa_inss_terceiros)." x ".$Aplicacao->Bd2Indice($indice); ?></td>
					<td class="borda-b"></td>
					<td class="borda-r"></td>
				</tr>
				<?php } ?>
			...
			<table cellpadding="5" cellspacing="0" border="0">
				...
				<tr>
					...
					<td class="borda-bb <?=$borda_t;?>">
						<?php echo $consulta_custas[$c]->get('nome_custa').", fl. ".$consulta_custas[$c]->get('folhas_custa');?>
					</td>
					<td class="<?=$borda_t;?>"></td>
					<td class="borda-bb <?=$borda_t;?> explicativo">R$</td>
					<td class="borda-bb <?=$borda_t;?>" align="center"><?php echo $Aplicacao->Bd2real($consulta_custas[$c]->get('valor_custa')); ?></td>
					<td class="borda-r <?=$borda_t;?>"></td>
				</tr>
				<tr>
					<td class="borda-l"></td>
					<td class="borda-b explicativo"><?php echo "Índice: ".$Aplicacao->Bd2Indice($indice)." &nbsp; &nbsp; &nbsp; &nbsp; Cálculo:  R$ ".$Aplicacao->Bd2real($consulta_custas[$c]->get('valor_custa'))." x ".$Aplicacao->Bd2Indice($indice); ?></td>
					<td class="borda-b"></td>
					<td class="borda-b explicativo">R$</td>
					<td class="borda-b" align="center"><?php echo $Aplicacao->Bd2real($custa_atualizada); ?></td>
					<td class="borda-r"></td>
				</tr>
				<?php
					}
